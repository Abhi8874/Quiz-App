...
import com.abhishekmaurya.quizapp.Models.WithdrawRequest;
import com.abhishekmaurya.quizapp.R;
import com.abhishekmaurya.quizapp.SpinnerActivity;
import com.abhishekmaurya.quizapp.databinding.FragmentWalletBinding;
        ...
        binding.requestBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (user.getCoins() > 5000) {
                    ...
                    String payPal = binding.etPayEmail.getText().toString();
