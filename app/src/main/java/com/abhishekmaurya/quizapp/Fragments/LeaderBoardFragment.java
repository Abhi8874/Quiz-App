...
import com.abhishekmaurya.quizapp.Adapters.LeaderboardsAdapter;
import com.abhishekmaurya.quizapp.Models.User;
import com.abhishekmaurya.quizapp.R;
import com.abhishekmaurya.quizapp.databinding.FragmentLeaderBoardBinding;
...
public class LeaderBoardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.recycleViewLeader.setAdapter(adapter);
        binding.recycleViewLeader.setLayoutManager(new LinearLayoutManager(getContext()));
